...
public class Room {
    ...
    private Hotel hotel;
    public Room(int id, String room_type, int bed_num, int stock, boolean tv, boolean minibar, boolean oyun) {
        this.id = id;
    ...
    public void setOyun(boolean oyun) {
        this.oyun = oyun;
    }
    ...
    public static boolean add(String room_type, int stock, int hotel_id, int bed_num, boolean tv, boolean minibar, boolean oyun){
        String query = "INSERT INTO room (room_type, stock, hotel_id, bed_num, tv, minibar, oyun) VALUES (?,?,?,?,?,?,?)";
